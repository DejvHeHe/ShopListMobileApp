...
export async function get(shopListId) {
  try {
    ...
    const response = await fetch(
      `http://192.168.0.45:5000/shoplist/get?shopListId=${shopListId}`,
      {
        method: "GET",
        headers: {
          "Authorization": `Bearer ${token}`,
...
export async function listArchived() {
  try {
    ...
    const response = await fetch("http://192.168.0.45:5000/shoplist/listArchived", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
...
export async function viewSharedTo(shopListId) {
  try {
    ...
    const response = await fetch(
      `http://192.168.0.45:5000/shoplist/viewSharedTo?shopListId=${shopListId}`,
      {
        method: "GET",
        headers: {
          "Authorization": `Bearer ${token}`,
...
export async function setArchived(data) {
  try {
    ...
    const response = await fetch("http://192.168.0.45:5000/shoplist/setArchived", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        "Authorization": `Bearer ${token}`,
